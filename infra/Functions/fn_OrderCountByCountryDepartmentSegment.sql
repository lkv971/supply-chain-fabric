CREATE FUNCTION SupplyChain.fn_OrderCountByCountryDepartmentSegment(@Country VARCHAR(200) = NULL, @Year INT = NULL, @Month INT = NULL)
RETURNS TABLE
AS RETURN
(SELECT d.DepartmentName, c.Segment, COUNT(o.OrderID) AS OrderCount
